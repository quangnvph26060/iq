                        ...
                        <div
                            ...
                            <div className="login login-v2">
                                ...
                                <div className="login-content">
                                    ...
                                    <form onSubmit={handleSubmit} className="form-with-label">
                                        ...
                                        <div className="step1 js-step1">
                                            ...
                                            <div className="form-bottom rules form-bottom_2-col">
                                                ...
                                                <div className="recovery-link">
                                                    <a href="https://pocketoption.com/vt/password_recovery/">
                                                        Khôi phục mật khẩu!
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div className="form-group social-container">
                                            <p className="social-container__title">Hoặc đăng nhập bằng</p>
                                            <div
